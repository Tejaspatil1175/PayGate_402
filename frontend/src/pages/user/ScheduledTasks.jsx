      ...
      <div className="space-y-4 sm:space-y-6">
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 border-b border-slate-200 pb-4 sm:pb-6">
          ...
          <button
            ...
            className="flex items-center gap-2 px-4 py-2.5 rounded-xl bg-indigo-600 hover:bg-indigo-700 text-white text-xs font-bold transition shadow-sm self-start md:self-auto"
          >
          ...
          <div className="fixed inset-0 bg-slate-900/50 backdrop-blur-xs z-50 flex items-center justify-center p-4">
            <div className="bg-white border border-slate-200 rounded-2xl p-6 max-w-md w-full shadow-2xl space-y-4">
              <div className="flex items-center justify-between border-b border-slate-100 pb-3">
                <h3 className="font-bold text-slate-900 text-base">Schedule Automated Task</h3>
                <button
              ...
              <form onSubmit={handleCreateTask} className="space-y-3 text-xs">
                <div>
                  ...
                  <input
                    ...
                    className="w-full bg-slate-50 border border-slate-300 focus:border-indigo-500 focus:bg-white rounded-xl px-3 py-2 text-slate-900 font-medium outline-none"
                  />
                </div>

                <div>
                  <label className="block text-slate-600 font-medium mb-1">Item Keywords</label>
                  <input
                    type="text"
                    required
                    value={itemKeywords}
                ...
                <div className="grid grid-cols-2 gap-3">
                  ...
                  <div>
                    <label className="block text-slate-600 font-medium mb-1">Budget Cap (₹)</label>
                    <input
                      type="number"
                      required
                      min="100"
                      ...
                      className="w-full bg-slate-50 border border-slate-300 focus:border-indigo-500 focus:bg-white rounded-xl px-3 py-2 text-slate-900 font-bold outline-none"
                    />
                  </div>
                </div>

                <div>
                  <label className="block text-slate-600 font-medium mb-1">Schedule Execution Time</label>
                  <input
                    type="datetime-local"
                    required
                    value={scheduleTime}
                ...
                <div className="pt-2 flex items-center justify-end gap-2 border-t border-slate-100">
                  ...
                  <button
                    ...
                    className="px-4 py-2 rounded-xl bg-indigo-600 hover:bg-indigo-700 text-white font-bold transition shadow-sm disabled:opacity-50"
                  >
              ...
              return (
                ...
                >
                  <div className="space-y-3">
                    ...
                    <h3 className="font-bold text-slate-900 text-sm">{t.taskName}</h3>

                    <div className="space-y-1 text-xs text-slate-600">
                      <div><span className="text-slate-400">Keywords:</span> <span className="font-semibold text-slate-800">{t.intent?.itemKeywords}</span></div>
                      <div><span className="text-slate-400">Budget Cap:</span> <span className="font-bold text-slate-900">₹{t.intent?.budgetCap}</span></div>
                      <div className="flex items-center gap-1 text-indigo-600 font-semibold pt-1">
                  ...
                  {isScheduled && (
                    <div className="flex items-center gap-2 pt-3 border-t border-slate-100">
                      <button
                        ...
                        className="flex-1 bg-emerald-600 hover:bg-emerald-700 text-white text-xs font-bold rounded-xl py-2 flex items-center justify-center gap-1 transition shadow-xs"
                      >
                      ...
                      <button
                        ...
                        className="p-2 rounded-xl bg-slate-50 border border-slate-200 hover:bg-rose-50 hover:border-rose-300 text-slate-500 hover:text-rose-600 transition"
                        title="Cancel Task"
                      >
