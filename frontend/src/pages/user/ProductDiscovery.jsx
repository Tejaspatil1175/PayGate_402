  ...
  return (
    <div className="p-3 sm:p-5 md:p-6 pt-2 sm:pt-4 md:pt-4 space-y-3 sm:space-y-4 max-w-7xl mx-auto w-full">
      <div className="space-y-3 sm:space-y-4">
        ...
        {/* Filter Bar */}
        <div className="relative flex flex-col sm:flex-row items-stretch sm:items-center justify-between gap-3 bg-white p-3 sm:p-4 rounded-2xl border border-slate-200 shadow-2xs">
          {/* Category Tabs */}
          ...
          <div className="relative flex justify-end">
            <button
              ...
              className={`flex items-center justify-center gap-2 px-3.5 py-1.5 rounded-xl border text-xs font-semibold transition cursor-pointer w-full sm:w-auto ${
            ...
            {/* Filter Card Popup */}
            {showFiltersModal && (
              <div className="absolute right-0 top-full mt-2 w-72 max-w-[calc(100vw-32px)] bg-white border border-slate-200 rounded-2xl p-4 shadow-xl z-40 space-y-4 animate-in fade-in zoom-in-95 duration-150">
